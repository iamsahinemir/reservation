...
// Check the account_status variable
$account_status = 0; // Default value
...
<div class="navbar">
        ...
        <div class="menu">
            ...
            <a href="admin_rez.php">Make Reservation</a>
    ...
    <form id="reservationForm" action="make_reservation.php" method="POST">
        ...
        <?php if ($account_status == 1): ?>
            <div class="form-group" id="computerDropdown">
                <label for="computers">Select Computer:</label>
        ...
        <div class="form-group" id="deskDropdown">
            <label for="desks">Select Desk:</label>
        ...
        <div id="reservationDetails">
            ...
            <div class="form-group">
                ...
                <input type="text" id="aciklama" name="aciklama" placeholder="Why will you use this device?" required>
            </div>
        ...
        <?php if ($account_status == 0): ?>
            <div class="alert alert-info" role="alert">
                To create a computer account, please email <a href="mailto:ccip@khas.edu.tr">ccip@khas.edu.tr</a>.
            </div>
        <?php endif; ?>
    </form>
</div>
